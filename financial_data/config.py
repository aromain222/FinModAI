"""
Configuration for financial data providers and assumptions engine.
"""
...
# Provider settings
PROVIDER_TIMEOUT = 30  # Timeout in seconds
PROVIDER_MAX_RETRIES = 3
PROVIDER_RETRY_DELAY = 2  # Initial delay in seconds
PROVIDER_PRIORITY = ["yahoo", "alphavantage", "fmp", "google_sheets"]

# Caching settings
CACHE_TTL = 86400  # 24 hours in seconds

# Default values (only used as last resort fallbacks)
DEFAULT_RISK_FREE_RATE = 0.042  # 4.2% as of 2025
DEFAULT_EQUITY_RISK_PREMIUM = 0.055  # 5.5% for developed markets
...
INDUSTRY_PARAMS: Dict[str, Dict[str, Any]] = {
    "Technology": {
