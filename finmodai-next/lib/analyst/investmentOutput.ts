...
import { buildDeterministicStrategicContext } from '@/lib/analyst/strategicContext';
...
export function deriveOutputFromDcf(dcf: AnalystDcfDemoPayload): AnalystOutput {
  ...
  const strategicContext = dcf.strategicContext?.trim() || buildDeterministicStrategicContext({
    ticker: dcf.ticker,
