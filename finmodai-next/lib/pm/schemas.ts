...
export const agentViewSchema = z.object({
  ...
  createdAt: isoString.default(() => new Date().toISOString()),
  source: z.enum(['hedge_fund', 'tradingagents', 'dexter', 'rank', 'forecast', 'news', 'pm_brain', 'quant', 'manual']).optional(),
  positionId: z.string().optional(),
  agentType: z.enum(['hedge_fund', 'tradingagents', 'dexter', 'pm_brain', 'catalyst', 'forecast', 'quant']).optional(),
