...
const MOCK_PROFILES: Record<string, MockProfile> = {
  AAPL: {
    ...
    breakdown: { forecastSignal: 6.5, catalystStrength: 6.0, momentum: 6.8, earningsSetup: 6.5, riskAdjustment: 7.0 },
  ...
  MSFT: {
    ...
    breakdown: { forecastSignal: 7.2, catalystStrength: 7.5, momentum: 7.0, earningsSetup: 7.8, riskAdjustment: 7.5 },
  ...
  NVDA: {
    ...
    breakdown: { forecastSignal: 8.8, catalystStrength: 9.0, momentum: 8.5, earningsSetup: 9.2, riskAdjustment: 5.5 },
  ...
  GOOGL: {
    ...
    breakdown: { forecastSignal: 7.0, catalystStrength: 6.5, momentum: 6.2, earningsSetup: 7.0, riskAdjustment: 6.5 },
  ...
  META: {
    ...
    breakdown: { forecastSignal: 8.0, catalystStrength: 7.8, momentum: 8.2, earningsSetup: 8.0, riskAdjustment: 6.0 },
  ...
  AMZN: {
    ...
    breakdown: { forecastSignal: 8.2, catalystStrength: 7.5, momentum: 7.8, earningsSetup: 8.2, riskAdjustment: 6.5 },
  ...
  TSLA: {
    ...
    breakdown: { forecastSignal: 3.8, catalystStrength: 4.5, momentum: 3.5, earningsSetup: 3.8, riskAdjustment: 3.0 },
  ...
  NFLX: {
    ...
    breakdown: { forecastSignal: 6.2, catalystStrength: 6.0, momentum: 6.5, earningsSetup: 6.0, riskAdjustment: 6.0 },
...
function computeScore(bd: ScoreBreakdown): number {
  const raw =
    bd.forecastSignal * 0.30 +
    bd.catalystStrength * 0.25 +
    bd.momentum * 0.20 +
    bd.earningsSetup * 0.15 +
    bd.riskAdjustment * 0.10;
