...
def validate_dcf_assumptions(assumptions: Dict[str, Any]) -> Tuple[List[ValidationError], List[ValidationWarning]]:
    """
...
def validate_lbo_assumptions(assumptions: Dict[str, Any]) -> Tuple[List[ValidationError], List[ValidationWarning]]:
    """
...
def validate_comps_assumptions(assumptions: Dict[str, Any]) -> Tuple[List[ValidationError], List[ValidationWarning]]:
    """
...
def validate_merger_assumptions(assumptions: Dict[str, Any]) -> Tuple[List[ValidationError], List[ValidationWarning]]:
    """
